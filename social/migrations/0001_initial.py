# Generated by Django 3.0.5 on 2020-05-02 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('single', 'single'), ('married', 'married'), ('widow', 'widow'), ('seperated', 'seperated'), ('commited', 'commited')], default='single', max_length=20)),
                ('gender', models.CharField(choices=[('male', 'nale'), ('female', 'female'), ('other', 'other')], default='male', max_length=20)),
